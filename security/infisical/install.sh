...
kubectl apply -f security/namespace.yml
...
kubectl apply -f security/infisical/cluster-role-binding.yml -n $NAMESPACE
kubectl apply -f security/infisical/service-account.yml -n $NAMESPACE
kubectl apply -f security/infisical/service-account-reviewer.yml -n $NAMESPACE
kubectl apply -f security/infisical/secret-token-reviewer.yml -n $NAMESPACE
kubectl apply -f security/infisical/infisical-config.yml -n $NAMESPACE
